...
I](https://odsc.com/speakers/modern-machine-learning-in-r-part-i/) and
[Part
II](https://odsc.com/speakers/modern-machine-learning-in-r-part-ii/)
will work out of this repo.
...
``` sh
git clone https://github.com/jaredlander/odscwest2020.git
```

Then open the `odscwest2020.Rproj` file.
...
Paste `https://github.com/jaredlander/odscwest2020`\[3\] in the
...
# get the repo
newProject <- usethis::use_course('https://github.com/jaredlander/odscwest2020/archive/master.zip')
```
...
`odscwest2020` or `odscwest2020-master`. You can see this in the top
...
2.  Or git clone <git@github.com>:jaredlander/odscwest2020.git for ssh.

3.  Or <git@github.com>:jaredlander/odscwest2020.git for ssh.
