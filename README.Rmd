...
params:
    className: "Machine Learning in R Parts II & IV"
    repoName: "odscwest2020"
...
This is an empty repo to initialize an R project for class at `r organizer`. Both [Part I](https://odsc.com/speakers/modern-machine-learning-in-r-part-i/) and [Part II](https://odsc.com/speakers/modern-machine-learning-in-r-part-ii/) will work out of this repo.
